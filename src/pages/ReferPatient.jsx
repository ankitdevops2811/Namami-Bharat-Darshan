...
import PediatricCards from "./peadiatric/PediatricCards";
      ...
      <div className="container-fluid bg-primary py-5 hero-header mb-5">
        <div className="row py-3">
          <div className="col-12 text-center">
            ...
            <p>
            The best rehabilitation hospital in the country has gotten even better. See why your patients will benefit from care at the Mission Walk
            </p>
          </div>
        </div>
      </div>
