  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          backgroundImage: `url(https://napacenter.org/wp-content/uploads/2021/09/Functional-Estim.jpg)`,
        }}
      >
              ...
              <div className="our_programs_details_inner">
                ...
                <div className="our_programs_details_right">
                  ...
                  <p>
                    ...
                    implemented during therapeutic activities to assist with
                    promoting or restoring function in muscles that may be weak
