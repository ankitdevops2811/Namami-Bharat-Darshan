              ...
              <div className="our_programs_details_inner">
                ...
                <div className="our_programs_details_right">
                  ...
                  <p style={{ fontSize: "22px" }}>
                    ...
                    platform, therapists are able to use the Galileo to address
                    a variety of therapeutic goals including balance training,
                  ...
                  <p style={{ fontSize: "22px" }}>
                    ...
                    function ensures that the patient gains the most out of
                    their training time by disallowing the muscles to
