    ...
    <>
        ...
        <div className="row py-3">
          <div className="col-12 text-center">
            ...
            <p
              ...
              style={{ fontSize: "18pxl" }}
            >
              Take a look inside the innovation happening inside Mission Walk
              Centre
            </p>
          </div>
        </div>
      ...
      <section>
        <div className="mt-5">
          <div className="card">
            <div
              className="card-body shadow h-100 p-3 mb-5 bg-warning rounded"
              style={{ fontSize: "38px", textAlign: "center", height: "100" }}
            >
              <a
                href="https://www.youtube.com/@MissionWalk"
                target="_blank"
