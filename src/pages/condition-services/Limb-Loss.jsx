        ...
        <div className='row py-3'>
          <div className='col-12 text-center'>
            ...
            <p className='h4 text-white'>
              Amputation or limb impairment can affect ability, but doesn’t have
              to affect the quality of your life. We meet patients’ unique needs
              by integrating medical expertise, technology, engineering
              (prosthetics, orthotics, bionics, robotic devices) and a range of
              therapies.
            </p>
          </div>
        </div>
        ...
        <div className='container'>
          <div className='row g-5'>
            <div className='col-lg-7'>
              ...
              >
                You want to recover what’s most important in your life. We
                challenge ourselves to innovate ways to make that possible.
              </p>
                ...
                <div className='col-sm-6 wow zoomIn' data-wow-delay='0.3s'>
                  <Card style={{ width: '18rem' }}>
                    ...
                    <Card.Body>
                      ...
                      <Card.Text>
                        Ethan was enjoying his work as a healthcare consultant
                        after graduating from Northwestern. In January 2015 an
                        infection led to a life-changing outcome..
                      </Card.Text>
                    </Card.Body>
                  </Card>
                </div>
                <div className='col-sm-6 wow zoomIn' data-wow-delay='0.6s'>
                  <Card style={{ width: '18rem' }}>
                    ...
                    <Card.Body>
                      ...
                      <Card.Text>
                        Certified prosthetics and orthotics clinicians, working
                        collaboratively with your doctors and therapists to
                        deliver your customized device needs.
                      </Card.Text>
                    </Card.Body>
                  </Card>
                </div>
              ...
              <div className='our_programs_details_inner'>
                ...
                <div className='our_programs_details_right'>
                  ...
                  <p style={{ fontSize: '22px', textAlign: 'justify' }}>
                    At the cutting edge of prosthetics, bionics, and care, our
                    specialized Innovation Center and Ability Lab set patients
                    up for the best possible outcomes.
                  </p>
                  <div className='col-sm-6 wow zoomIn' data-wow-delay='0.6s'>
                  ...
                  <p style={{ fontSize: '22px', textAlign: 'justify' }}>
                    ...
                    to the needs of patients with limb loss or impairment — we
                    offer you access to the world’s most advanced research,
                    which can directly impact your outcome. Our prosthetics —
                    including thought-controlled bionic limbs — are
                    revolutionary.
