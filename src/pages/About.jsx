      ...
      <div className="card container-fluid bg-primary py-5 hero-header mb-5 ">
        <div className="row py-3">
          <div className="col-12 text-center">
            ...
            <a href="" className="h4 text-white">Dr. Ravi Badavath
(Neuro physiotherapist, Founder of “Mission Walk”)</a>
      ...
      <div className="container-fluid py-3 wow fadeInUp" data-wow-delay="0.1s">
          ...
          <div className="row">
            <div className="col">
              <div className="section-title mb-4">
                <h5 className="position-relative d-inline-block text-primary text-uppercase" style={{ fontSize: "35px" }}>
                  <strong>
                  About Us

                  </strong>
                </h5>
                <h1 className="display-5 mb-0  wow fadeInUp" style={{ fontSize: '26px',textAlign:"justify" }}>
                  Mission Walk : The story of my Entrepreneurship Journey
                  Hope for neurologically disabled in India
                </h1>
              </div>
              <h4 className="text-body fst-italic mb-4  wow fadeInUp" style={{ fontSize: '22px' }}>
                Dr. Ravi Badavath
                <br />(Neuro physiotherapist, Founder of “Mission Walk”)
              </h4>
              <p className="mb-4  wow fadeInUp" style={{ fontSize: '20px', textAlign:"justify" }}>
            ...
            <div className="col-lg-3" style={{ minHeight: "800px" }}>
              ...
              <img
                  className=" col-lg-2 position-right w-100 h-80 rounded wow zoomIn" 
                  data-wow-delay="0.9s"
        ...
        <div className=" position-right w-100 h-80 wow zoomIn">
